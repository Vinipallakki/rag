...
# ---- Inline text (replace large file) ----
example_text = """
Artificial Intelligence (AI) is a branch of computer science that aims to create machines capable of intelligent behavior.
It involves machine learning, natural language processing, computer vision, and robotics.
AI systems can learn from data, adapt, and perform tasks that typically require human intelligence.
My dog name is Lara
"""

# ---- Chunk the inline text ----
chunks = chunk_text_safe(example_text)
...
vectordb.add_texts(
    texts=chunks,
    metadatas=[{"source": "inline_text", "chunk_index": i} for i in range(len(chunks))]
)

print(f"✅ Ingested {len(chunks)} chunks from inline text")
